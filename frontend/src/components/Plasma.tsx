...
const buildFragment = (_iterations: number): string => `#version 300 es
precision highp float;
...
export const Plasma: FC<PlasmaProps> = ({
  color = '#ffffff',
  speed = 1,
  direction = 'forward',
  scale = 1,
  ...
  useEffect(() => {
    ...
    const loop = (t: number) => {
      ...
      if (pendingMouse.current) {
        ...
        const mouseUniform: Float32Array = program.uniforms.uMouse.value;
